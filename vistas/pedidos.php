...
<div class="panel-body" style="height: 400px;" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    ...
    <div class="form-group col-lg-3 col-md-3 col-xs-12">
      <label for="">Planta de abastecimiento: </label>
     <select name="planta" id="planta" class="form-control selectpicker" required>
    ...
    <div class="form-group col-lg-3 col-md-3 col-xs-6">
      ...
      <input class="form-control" type="text" name="vehiculo" id="vehiculo" maxlength="10" placeholder="vehiculo" >
    </div>
    
    <div class="form-group col-lg-2 col-md-2 col-xs-6">
      <label for="">Hora Entrega: </label>
      <input class="form-control" type="time" name="hora_entrega" id="hora_entrega" maxlength="10" placeholder="Numero" >
    </div>
    ...
    <div class="form-group col-lg-12 col-md-12 col-xs-12">
        ...
        <input class="form-control" type="text" name="observaciones" id="observaciones" maxlength="200" placeholder="Observaciones">
    </div>
