...
$formula=isset($_POST["formula"])? limpiarCadena($_POST["formula"]):"";
...
switch ($_GET["op"]) {
	...
	if (empty($idarticulo)) {
		$rspta=$articulo->insertar($idcategoria,$codigo,$nombre,$stock,$descripcion,$imagen,$uso, $formula);
		echo $rspta ? "Datos registrados correctamente" : "No se pudo registrar los datos";
	}else{
         $rspta=$articulo->editar($idarticulo,$idcategoria,$codigo,$nombre,$stock,$descripcion,$imagen,$uso, $formula);
